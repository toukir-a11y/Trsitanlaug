...
<section class="banner has--overlay" style="background-image:linear-gradient(black, black), url('<?php echo get_template_directory_uri();?>../images/banner.jpg');">
<div class="container h-100">
	<div class="row h-100 align-items-end">
		<div class="col-12">
			<div class="banner__content text-center">
				<h1 class="title fs text-uppercase">Tristan</h1>
						...
						<div class="col-12">
							<a href="film-details.html" class="films__card has--overlay">
								...
								<div class="films__card-text text-center">
									<h2 class="title text-uppercase">Empty</h2>
